...
const Educational = () => {
    ...
    useEffect(async () => {
        let response = await axios_util('/get-posts', { type: "unp" });
    ...
    return (
        <div className={styles.container}>
            <div className={styles.navbar}>
                ...
                <div className={styles.logo_box} style={{margin: "auto", fontSize: "30px", textAlign: "center", width: "70%"}}>
            ...
            </div>
            {
                ...
                <div className={styles.add_post}>
                    ...
                    <div className={styles.add_post_bar} onClick={() => {
                        ...
                        <p>
                            post here if you want to share in the university news portal
                        </p>
                    </div>
                </div>
            }
