...
const Educational = () => {
  ...
  useEffect(async () => {
    let response = await axios_util('/get-posts', { type: 'eh' });
      ...
      </div>
      {
        ...
        <div className={styles.add_post}>
          ...
          <div className={styles.add_post_bar} onClick={() => {
            ...
            <p>
              This are the educational help posts that you posted
            </p>
          </div>
        </div>
      }
            ...
            posts.map((current, index) =>
              <div key={index} className={styles.post}>
                ...
                <div className={styles.post_main}>
                  Help with this following topic is needed.
                </div>
                ...
                <div className={styles.post_contact} style={{ display: 'flex', justifyContent: 'center', cursor: 'pointer' }}>
                  <div onClick={() => { setModalIsOpen(true) }}> see problem images </div>
                </div>
              </div>
            )
          }
